...
class Job(models.Model):
    ...
    active = models.BooleanField(default=True, choices=STATUS_CHOICES, help_text="for admins only if you want deactive job") # For Admins
    ...
    def save(self, *args, **kwargs):
        """ make a slug to job, rename a image and resize a big image """
